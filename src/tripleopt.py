...
if __name__ == '__main__':
    ...
    for cp_family in cp_families:
        ...
        hyper_log_prefix = model_types[0] + '-TripleOpt-' + cp_family
        ...
        for i in range(len(ins_abs_stgs)):
            ...
            for unique_fun_stg in unique_fun_stgs:
                ...
                model_name = model_types[0] + '-TripleOpt-' + cp_family + '#' + func_rep_stg + '#' + \
                ...
                run_whole_procedure(model_name.replace('.pkl', ''), corpus_path, dic_file_path, path_stg_suffix,
                                    ...
                                    label_maps, task_str='tripleopt', family=cp_family,
