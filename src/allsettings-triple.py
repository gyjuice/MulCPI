...
if __name__ == '__main__':
    ...
    hyper_log_prefix = model_types[0] + '-allsettings-triple'
    ...
    for i in range(len(ins_abs_stgs)):
        ...
        for unique_fun_stg in unique_fun_stgs:
            ...
            model_name = model_types[0] + '-allsettings-triple#' + func_rep_stg + '#' + \
            ...
            run_whole_procedure(model_name.replace('.pkl', ''), corpus_path, dic_file_path, path_stg_suffix,
                                ...
                                label_maps, task_str='allsettings-triple', version_list=all_versions,
