...
def run_whole_procedure(fig_prefix_org, corpus_path, dic_file_path, func_rep_stg, unique_funs_file, num_classes,
    ...
    db = CFGDataset(corpus_path, dic_file_path, func_rep_stg, unique_funs_file, label_maps, task_str=task_str,
                    family=family, version_list=version_list, black_list=black_list)
...
if __name__ == '__main__':
    ...
    black_list = ['gcc-4.8', 'gcc-4.9', 'gcc-5', 'gcc-7']
    ...
    all_versions = ['3.8', '5.0', '4.7', '6', '19.0.4']
    ...
    hyper_log_prefix = model_types[0] + '-allsettings-binary'
    ...
    for i in range(len(ins_abs_stgs)):
        ...
        for unique_fun_stg in unique_fun_stgs:
            ...
            model_name = model_types[0] + '-allsettings-binary#' + func_rep_stg + '#' + \
            ...
            run_whole_procedure(model_name.replace('.pkl', ''), corpus_path, dic_file_path, path_stg_suffix,
                                ...
                                label_maps, task_str='allsettings-binary', version_list=all_versions,
                                model_types=model_types, node_vec_stg_list=node_vec_stg_list, black_list=black_list)
